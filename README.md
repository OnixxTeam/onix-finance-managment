...
переводит их в «Другое» — обе операции необратимы, поэтому удаление спрашивает
подтверждение и называет число затронутых записей. Категорию «Другое» изменить нельзя:
